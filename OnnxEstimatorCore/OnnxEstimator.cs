...
namespace OnnxEstimatorLib
{
    public class OnnxEstimator
    {
        ...
        private static void ConfigureLogger(string fileDir)
        {
        ...
        private static Player CreatePlayer(OnnxModel onnxModel)
        {
        ...
        private static OnnxModel RunGameSession(OnnxModel modelOne, OnnxModel modelTwo)
        {
